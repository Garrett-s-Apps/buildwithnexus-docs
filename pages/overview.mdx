...
NEXUS is an enterprise multi-agent orchestration system that operates as a complete autonomous software engineering organization. Instead of a single AI assistant, NEXUS deploys 27 specialized agents organized into a hierarchical org chart — from C-suite executives to implementation engineers.
...
NEXUS operates with **27 active agents** organized into 6 hierarchical layers:
